...
def test_mpc_inv_pend_model_simple_sampling(simple_model_init_params):
    time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, init_state, cart_mass, pendulum_mass, sample_input = simple_model_init_params
