...
def sampler_init_params():
    ...
    return time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, \
           init_state, std_dev
...
def test_mpc_stddev_inv_pendulum_sample_input(std_dev_inv_pendulum_model_init_params):
    time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, \
    init_state, cart_mass, pendulum_mass, nominal_input, std_dev = std_dev_inv_pendulum_model_init_params
...
def test_mpc_barebones_sample(std_dev_sample_straight_line_params):
    time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, \
    init_state, cart_mass, pendulum_mass, nominal_input, std_dev = std_dev_sample_straight_line_params
