...
def test_config_init(setup_mock_config_dict_CartPole, config_model):
...
def model_init_params():
    ...
    return time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, init_state, cart_mass, pendulum_mass, sample_input

def test_mpc_inv_pend_model_init(model_init_params):
    time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, init_state, cart_mass, pendulum_mass, sample_input = model_init_params
...
def simple_model_init_params():
    ...
    cart_mass = 1 # kg
    pendulum_mass = 1 # kg
    sample_input = np.array([[1, 4, 7],
                             [2, 5, 8],
                             [3, 6, 9]]).reshape((3,3,1))
    return time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, init_state, cart_mass, pendulum_mass, sample_input

def test_mpc_inv_pend_model_simple_sampling(simple_model_init_params):
    time_step, commanded_lon_vel, horizon, sample_length, number_samples, input_dimension, state_dimension, init_state, cart_mass, pendulum_mass, sample_input = simple_model_init_params
