...
class InvPendulumModel(AbstractModel):
    def __init__(self, time_step, number_samples, sample_length, cart_mass, pendulum_mass):
    ...
    def _predict(self, init_state, input):
        ...
        state_diff = self.state_transition_matrix @ init_state \
                     + self.input_transition * input
